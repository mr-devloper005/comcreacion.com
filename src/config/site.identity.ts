export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'comcreacion',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Comcreacion',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'comcreacion.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://comcreacion.com',
