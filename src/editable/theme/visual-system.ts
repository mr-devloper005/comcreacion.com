...
export const visualSystem = {
  ...
  typography: {
    ...
    heroTitle: 'text-5xl font-semibold tracking-[-0.04em] sm:text-6xl lg:text-7xl',
    sectionTitle: 'text-3xl font-semibold tracking-[-0.03em] sm:text-4xl',
    body: 'text-base leading-8',
    caption: 'text-xs font-medium uppercase tracking-[0.18em]',
  },
  surfaces: {
    glass: 'border border-black/10 bg-white/60 backdrop-blur-xl',
    paper: 'border border-black/10 bg-white shadow-[0_24px_70px_rgba(18,18,18,0.1)]',
    quiet: 'border border-black/10 bg-black/[0.02]',
    dark: 'border border-white/10 bg-black/90 shadow-[0_24px_70px_rgba(0,0,0,0.4)]',
  },
  layout: {
